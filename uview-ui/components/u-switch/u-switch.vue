<template>
	<view class="u-switch" :class="[value == true ? 'u-switch--on' : '', disabled ? 'u-switch--disabled' : '']"
		...
		<text v-if="typeK" :style="value==false?'padding-left:50rpx':'padding-left: 8rpx;'"
			style="font-size: 20rpx;">{{value==true?'离职':'入职'}}</text>

		<text v-else :style="value == false ? 'padding-left:50rpx' : 'padding-left: 12rpx;'" style="font-size:20rpx;">{{ value
			== true ? '开' : '关' }}</text>
	</view>
</template>
